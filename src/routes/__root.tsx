...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mr Kriuk Ami - POS Kasir" },
      { name: "description", content: "Sistem kasir untuk Mr Kriuk Ami: kelola menu, transaksi, stok, dan laporan penjualan." },
      { property: "og:title", content: "Mr Kriuk Ami - POS Kasir" },
      { property: "og:description", content: "Sistem kasir untuk Mr Kriuk Ami: kelola menu, transaksi, stok, dan laporan penjualan." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Mr Kriuk Ami - POS Kasir" },
      { name: "twitter:description", content: "Sistem kasir untuk Mr Kriuk Ami: kelola menu, transaksi, stok, dan laporan penjualan." },

...
import { ArrowLeft, Trash2, Save, Plus, Minus, X, Search, Store } from "lucide-react";
...
function ExpenseDetails() {
  ...
  }, [allEntries, movements, search, typeFilter, role, branchName, user?.id, cashierBranchMap, selectedBranch]);
